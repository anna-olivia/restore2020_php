...
<body>
    <div class="wrap">
        <header>
            ...
            <div class="rechts">
                <h3>Hoppla, irgendwas ist schief gegangen:</h3>
            <p>Bitte geben Sie ihre Logindaten erneut ein!</p>

<p><a href="technik.php" title="Zurück zum Login">Zurück zum Login</a></p>   
